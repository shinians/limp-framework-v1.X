...
public class CommonServiceImpl implements CommonService {
    ...
    public void insertPageLog(PageLog pageLog) {
        try{
            ...
            if (StrUtils.isBlank(pageLog.getOtlState())) {
                pageLog.setOtlState(Constant.STATE_EFFECTIVE);
            }
            if (StrUtils.isBlank(pageLog.getOtlTime())) {
...
//           String reg=":"+key+"|:'"+key+"'|:\""+key+"\"";
    ...
    public String getCacheCodeValue(String key) {
        ...
        if(StrUtils.isBlank(val)){
            ...
            Pager<DicCodes> list=dictCodesService.getPageDomainList("",dicCodes,new Pager(1,1));

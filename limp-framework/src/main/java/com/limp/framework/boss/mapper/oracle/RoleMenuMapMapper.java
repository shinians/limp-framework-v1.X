...
import com.limp.framework.boss.domain.RoleMenuMap;
import com.limp.framework.boss.domain.RoleMenuMapExample;
import org.apache.ibatis.annotations.Param;

import java.util.List;

public interface RoleMenuMapMapper {
    int countByExample(RoleMenuMapExample example);

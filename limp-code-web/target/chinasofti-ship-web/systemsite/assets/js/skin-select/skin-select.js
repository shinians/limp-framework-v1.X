$(document).ready(function() { 
	...
	$("#skin-select #toggle").click(function() {
		if($(this).hasClass('active')) {
			...
			$('.wrap-fluid').css({"width":"auto","margin-left":"180px"});
			$('.navbar').css({"margin-left":"180px"});
...
//            $("#skin-select li i").css("left","-16px")

        } else {
			$(this).addClass('active')
			
			//$('#skin-select').animate({ left:-200 }, 100);
			$('#skin-select').animate({ left:-130 }, 100);
...
//            if(system.isPhone){
                $('.skin-part').css({"visibility":"visible", "top":"-11px"});
            /*}else{
...
//            $("#skin-select li i").css("left","56px")

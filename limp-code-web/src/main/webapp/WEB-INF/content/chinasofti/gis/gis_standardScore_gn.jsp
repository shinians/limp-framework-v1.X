...
<div class="legend">
    <p>
        <img src="${supermap}/theme/images/greenship.png">： <span> 渔船标准化高</span>
    </p>
    <p>
        <img src="${supermap}/theme/images/yellowstop.png">： <span> 渔船标准化中</span>
    </p>
    <p>
        <img src="${supermap}/theme/images/redstop.png">： <span> 渔船标准化低  </span>
    </p>
</div>
                    ...
                    success : function(data){
                        ...
                        if(data.msg == 'success'){
                            ...
                            for(var i = 0;i<result.length;i++){
                                ...
                                }else if(result[i].score <60 && result[i].score >= 0 ){

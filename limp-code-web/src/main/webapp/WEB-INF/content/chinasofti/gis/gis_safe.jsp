...
<head>
    ...
    <link rel="stylesheet" href="${plug}/layui-v2.2.6/css/layui.css" >
    <style type="text/css">
        body{
            margin: 0;
            overflow: hidden;
...
<div class="mapContainer">
    ...
    <div class="buttonGroup">
        <button class="layui-btn layui-btn-normal 3d-map">远洋渔船分布3D</button>
    </div>
    <%--<div class="legend">--%>
    <%--<p>--%>
            ...
            <div class="btnContent">
                ...
                <p style="text-align: left;line-height:30px;">
                    轨迹查询：<input type="text" class="layui-input" id="shipDate" placeholder="仅限查询最近90天内的轨迹数据">
                        ...
                        <button class="layui-btn layui-btn-normal layui-btn-sm" id="shipTimeClear">清除</button>
...
<script>
    ...
    function OrgBlity(options){
        ...
        var shipPoint = get_root + "/gis/getInYYShipPos";
        ...
        //渔船轨迹
        var shipTrajectory = get_root + "/gis/getYYShipTrack";
        //判断是否在筛选状态;
        var showShip = false;
        //获取筛选的obj
        var shipFilterObj;
        var layer1,shipMap,shipDraw,shipPoints,vectorlayer,infowin,s_arr,groupArr,pointFeature,searchShipLayer,infowinPosition,examineLayer,shipPortLayer,selectFeature,shipGroupFeature,shipPortFeature,jyShipLayer,graphicsLayer,markerLayer,layerLoad,lineLayer,drawLine,graphicLayer;
        ...
        OrgFun.prototype = {
            ...
            addLayer : function(){
                ...
                shipMap = new SuperMap.Layer.TiledDynamicRESTLayer("ship", oceanUrl, {transparent: true, cacheEnabled: true});
...
//                that.setFullPage();
            ...
            addLayer2 : function(){
                var that = this;
                map.addLayers([layer1,shipMap,shipDraw,shipPoints,vectorlayer,searchShipLayer,examineLayer,markerLayer,graphicLayer,shipPortLayer,graphicsLayer,jyShipLayer,lineLayer]);
            ...
            changeMap : function(){
                $('.3d-map').on('click',function(){
                    var url = get_root + "/gis/toOcean3d";
...
//                        +"</tr>"
            ...
            listenZoom : function(){
                ...
                if(zoomNum >= 8 && showShip){
                    ...
                    shipFilterObj.lng1 = obj.x1

                    shipFilterObj.lat1 = obj.y1

                    shipFilterObj.lng2 = obj.x2

                    shipFilterObj.lat2 = obj.y2
                    ...
                    //
                    //         if(data.result == 0){
                    //             layer.msg('没有筛选到相应的渔船，请更改筛选条件后再试');
                    //             return;
                    //         }
                    //
                ...
                $('#filter').on('click',function(){
                    ...
                    layui.use('form', function(){
                        ...
                        $('#filterOk').on('click',function(){
                            ...
                            if(shipFilterObj.ownerName == "" && shipFilterObj.status == "" && shipFilterObj.safeScore == "" && shipFilterObj.rate == "" && shipFilterObj.age == ""){
                                layer.msg('请至少选择一项筛选条件后再试')
                                return;
                            }
...
//                                           TODO传到后台
            ...
            shipDetail : function(e){
                ...
                if(!e.attributes.hasOwnProperty("shipId")){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        if(data.msg == 'success'){
                            ...
                            $('.shipDetailContent').on('click','#shipTimeClear',function(){
                                shipDraw.removeAllFeatures();
                                shipPoints.clearMarkers();
                            })
...
//                            })
            ...
            drawMarker : function(data){
                ...
                for(var i = 0; i<result.length; i++){
                    var point= new SuperMap.Geometry.Point(result[i].LON,result[i].LAT);
                    ...
                    pointVector.style={
                        image: new SuperMap.Style.Circle({
                            ...
                            fill: new SuperMap.Style.Fill({
                                color: "rgba(0, 216, 112, 0.7)"
                            }),
                            stroke: new SuperMap.Style.Stroke({
                                color: "rgba(126,181,230,0.2)",
                                width: 1
                            })
                        })
                    };

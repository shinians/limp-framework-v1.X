                                ...
                                <section>
                                    <div class="table-responsive">
                                        <table class="table  table-striped" id="userTable">
                                            <thead>
                                        <tr>
                                            <th style="cursor:pointer;text-align:center;white-space: nowrap;">
                                                KEY&nbsp;<span style="color: #ccc" class="lpsort lphide"><span
                                                    class="fontawesome-sort-up" value="USR_ACCOUNT ASC"></span><span
                                                    class="fontawesome-sort-down lpclick" style=" margin-left: -9px; "
                                                    value="USR_ACCOUNT DESC"></span></span></th>
                                            <th style="cursor:pointer;text-align:center;white-space: nowrap;">
                                                VALUE&nbsp;<span style="color: #ccc" class="lpsort lphide"><span
                                                    class="fontawesome-sort-up" value="USR_NAME ASC"></span><span
                                                    class="fontawesome-sort-down lpclick" style=" margin-left: -9px; "
                                                    value="USR_NAME DESC"></span></span></th>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left">uums</td>
                                                <td style="text-align:left">正常</td>
                                            </tr>
                                            <tr>

                                                <td style="text-align:left">测试用户</td>
                                                <td style="text-align:left">0</td>

                                            </tr>
                                            <tr>

                                                <td style="text-align:left">部局用户</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left">test61</td>
                                                <td style="text-align:left">0</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left">test7</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left">test123456</td>
                                                <td style="text-align:left">1</td>

                                            </tr>
                                            <tr>

                                                <td style="text-align:left">test0</td>

                                                <td style="text-align:left"><span style="color: red">已删除</span></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>

...
<body onload="init()" >
    ...
    <div id="abilityLevel" class="legend">
        <div class="level1">
            <input type="checkbox" value="1"  id="btn1" checked> GMDSS维修站能力80-100分：<img src="${supermap}/theme/images/green.png" alt="80-100分">
        </div>
        <div class="level2">
            <input type="checkbox" value="2"  id="btn2" checked> GMDSS维修站能力60-80分：<img src="${supermap}/theme/images/blue.png" alt="60-80分">
        </div>
        <div class="level3">
            <input type="checkbox" value="3"  id="btn3" checked> GMDSS维修站能力0-60分：<img src="${supermap}/theme/images/pure.png" alt="0-60分">
        </div>
    </div>
    <%--机构分布--%>
    <span class="showNews">
    ...
    <script type="text/javascript">
        ...
        var a_url=get_root+'/gis/getGMDSSData1';
        var org_url = get_root + '/gis/getGMDSSData2';
        var con;
...
//                new SuperMap.Control.LayerSwitcher(),
        ...
        function addLayer3(){
            map.addLayers([tiandi,layer1,tiandiVct,markerlayer,polygonLayer]);
            //显示地图范围
...
//                    //必加此行代码激活layui属性
            ...
            $('#searchContent').on('keyup',function(event){
                if(event.keyCode === 13){
                    ...
                    $.ajax({
                        type : "get",
                        url  : "/gis/getGMDSSData1?name="+htmlContent,
                        dataType : "json",
                        success :function(data){

                            if( data.result.length == 0 ){
                                layer.msg('没有搜索到"'+htmlContent+"\"的相关站点信息,请更换关键词查询");
                                return;
                            }else{

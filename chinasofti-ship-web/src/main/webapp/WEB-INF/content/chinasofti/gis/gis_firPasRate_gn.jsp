...
<div class="legend">
    <p>
        <img src="${supermap}/theme/images/greenship.png">： <span> 一次检验合格率80%-100%</span>
    </p>
    <p>
        <img src="${supermap}/theme/images/yellowstop.png">： <span> 一次检验合格率60%-80%</span>
    </p>
    <p>
        <img src="${supermap}/theme/images/redstop.png">： <span> 一次检验合格率0%-60%  </span>
    </p>
</div>
<div class="search">
...
<script>
    ...
    function OrgBlity(options){
        ...
        var markUrl = get_root + "/gis/getOceanShipData5";
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        if(data.msg == 'success'){
                            ...
                            var images;
                            for(var i = 0;i<result.length;i++){
                                if(result[i].checkRate >= 80 && result[i].checkRate <= 100){
                                    images  = "${supermap}/theme/images/greenship.png";
                                }else if (result[i].checkRate >= 60 && result[i].checkRate < 80){
                                    images  = "${supermap}/theme/images/yellowstop.png";
                                }else if(result[i].checkRate <60 && result[i].checkRate >= 0 ){
                            ...
                            for(var i = 0;i<result.length;i++){
                                ...
                                pointFeature.attributes = {
                                    ...
                                    mmsi : result[i].MMSI,
                                    shipCall : result[i].callSign,
                                    modelWidth : result[i].modelWidth,
                                    power : result[i].power,
                                    provName : result[i].provName,
                                    shipLength : result[i].shipLength,

...
<div class="legend">
    <p>
        <img src="${supermap}/theme/images/greenship.png">： <span> 船龄在0-15年</span>
    </p>
    <p>
        <img src="${supermap}/theme/images/yellowstop.png">： <span> 船龄在15-25年</span>
    </p>
    <p>
        <img src="${supermap}/theme/images/redstop.png">： <span> 船龄在25-35年  </span>
    </p>
</div>
<div class="search">
...
<script>
    ...
    function OrgBlity(options){
        ...
        var that = this;
        var markUrl = get_root + "/gis/getOceanShipData6";
                    ...
                    success : function(data){
                        if(data.msg == 'success'){
                            ...
                            for(var i = 0;i<result.dataList.length;i++){
                                if(result.dataList[i].age >= 0 && result.dataList[i].age < 15){
                                    images  = "${supermap}/theme/images/greenship.png";
                                }else if (result.dataList[i].age >= 15 && result.dataList[i].age < 25){
                                    images  = "${supermap}/theme/images/yellowstop.png";
                                }else if(result.dataList[i].age >= 25 && result.dataList[i].age < 35 ){
